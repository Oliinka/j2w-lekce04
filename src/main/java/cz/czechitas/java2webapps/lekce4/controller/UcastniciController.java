...
public class UcastniciController {
    ...
    new Ucastnik("Xenie","Princezna","zamek","https://www.postavy.cz/foto/xenie-foto.jpg","žena"),
    new Ucastnik("Hyacint","Král","zamek","https://www.postavy.cz/foto/hyacint-foto.jpg","muž"),
    ...
    new Ucastnik("Jekota","Čert","peklo","https://www.postavy.cz/foto/jekota-foto.jpg","muž")
    );
